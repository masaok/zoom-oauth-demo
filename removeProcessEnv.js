...
app.get('/', (req, res) => {
    ...
    const redirectURL = process.env.redirectURL || 'http://localhost:4000'
    const clientId = process.env.clientId || 'I4hyL2eQPaStcfI2oq0zg'
    const clientSecret = process.env.clientSecret || '7Q8htTMa580sMx7ztl6jxkGGzvKxbHG2'
